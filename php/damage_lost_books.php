            ...
            <div class="row">
                ...
                <div class="panel panel-success" style="margin-right: -300px;margin-left: 300px;">
                    <div class="panel-body">
                        ...
                        <form action="<?php echo $BASE_URL;?>index.php?page=search_damage_lost_books" method="post" enctype="multipart/form-data">
                        
                        <label>Book Name<em></em> :  </label>
                        <input  name="book_name" value="" placeholder="Book Name" id="input-price" required="" class="form-control" type="text">
                        <br /><br />
